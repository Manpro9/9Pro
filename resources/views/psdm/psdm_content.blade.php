...
@section('css')
    <link rel="stylesheet" type="text/css" href="{{ asset('public/css/psdm_css/psdm_content_css.css') }}">
@endsection

@section('scripts')
    <script type="text/javascript" src="{{ asset('public/js/psdm_js/psdm_content_js.js') }}"></script>
@endsection
...
@section('content')
    <div id="wrapper" style="padding-left: 0px;">
        ...
        <!-- INCLUDED CONTENT -->
            @include('psdm.psdm_included_content')
