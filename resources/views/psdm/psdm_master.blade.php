...
<head>
    ...
    <!-- ICON -->
    <link rel="icon" type="text/css" href="{{asset('public/images/icons/ukdw_icon.ico')}}">
    <!-- END OF ICON -->
	    ...
	    <div class="container-fluid">
	        <div class="navbar-header">
	        	...
	        	<div class="container">
	        		...
	        		<img src="{{ asset('public/images/ukdw_icon.jpg') }}" width="40px"></img>
	        		</a>
                		...
                		<div class="col-sm-3">
		                  <form action="" method="post" accept-charset="utf-8">
							<h5 style="color:#ffffff;">KRITIK & SARAN</h5>
								...
								<input type="submit" name="" value="KIRIM" style="float:right; margin-right:130px;"  />
							</br>
							</form>
                    	</div>
                    </div>
